...
var OfficeWhere = struct {
	...
	ID:         whereHelperuint{field: "`offices`.`id`"},
	Name:       whereHelpernull_String{field: "`offices`.`name`"},
	Zipcode:    whereHelpernull_String{field: "`offices`.`zipcode`"},
	State:      whereHelpernull_String{field: "`offices`.`state`"},
	City:       whereHelpernull_String{field: "`offices`.`city`"},
	Address:    whereHelpernull_String{field: "`offices`.`address`"},
	Country:    whereHelpernull_String{field: "`offices`.`country`"},
	Phone:      whereHelpernull_String{field: "`offices`.`phone`"},
	Email:      whereHelpernull_String{field: "`offices`.`email`"},
	BusinessID: whereHelpernull_Uint{field: "`offices`.`business_id`"},
	CreatedAt:  whereHelpertime_Time{field: "`offices`.`created_at`"},
	UpdatedAt:  whereHelpertime_Time{field: "`offices`.`updated_at`"},
}
...
var (
	officeAllColumns            = []string{"id", "name", "zipcode", "state", "city", "address", "country", "phone", "email", "business_id", "created_at", "updated_at"}
	officeColumnsWithoutDefault = []string{"name", "zipcode", "state", "city", "address", "country", "phone", "email", "business_id"}
	officeColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
...
// CountG returns the count of all Office records in the query, and panics on error.
...
func (o *Office) Business(mods ...qm.QueryMod) businessQuery {
...
func (officeL) LoadBusiness(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOffice interface{}, mods queries.Applicator) error {
	var slice []*Office
	var object *Office
...
// SetBusinessG of the office to the related item.
// Sets o.R.Business to related.
// Adds o to related.R.Offices.
// Uses the global database handle.
func (o *Office) SetBusinessG(ctx context.Context, insert bool, related *Business) error {
	return o.SetBusiness(ctx, boil.GetContextDB(), insert, related)
}

// SetBusinessP of the office to the related item.
// Sets o.R.Business to related.
// Adds o to related.R.Offices.
// Panics on error.
func (o *Office) SetBusinessP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Business) {
	if err := o.SetBusiness(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetBusinessGP of the office to the related item.
// Sets o.R.Business to related.
// Adds o to related.R.Offices.
// Uses the global database handle and panics on error.
func (o *Office) SetBusinessGP(ctx context.Context, insert bool, related *Business) {
	if err := o.SetBusiness(ctx, boil.GetContextDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetBusiness of the office to the related item.
// Sets o.R.Business to related.
// Adds o to related.R.Offices.
func (o *Office) SetBusiness(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Business) error {
	var err error
	if insert {
...
// Uses the global database handle.
func (o *Office) RemoveBusinessG(ctx context.Context, related *Business) error {
...
// Removes o from all passed in related items' relationships struct (Optional).
// Panics on error.
func (o *Office) RemoveBusinessP(ctx context.Context, exec boil.ContextExecutor, related *Business) {
...
// Removes o from all passed in related items' relationships struct (Optional).
// Uses the global database handle and panics on error.
func (o *Office) RemoveBusinessGP(ctx context.Context, related *Business) {
...
// Sets o.R.Business to nil.
// Removes o from all passed in related items' relationships struct (Optional).
func (o *Office) RemoveBusiness(ctx context.Context, exec boil.ContextExecutor, related *Business) error {
	var err error
...
func FindOfficeG(ctx context.Context, iD uint, selectCols ...string) (*Office, error) {
...
func FindOfficeP(ctx context.Context, exec boil.ContextExecutor, iD uint, selectCols ...string) *Office {
...
func FindOfficeGP(ctx context.Context, iD uint, selectCols ...string) *Office {
...
func FindOffice(ctx context.Context, exec boil.ContextExecutor, iD uint, selectCols ...string) (*Office, error) {
	officeObj := &Office{}
...
func (o *Office) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	o.ID = uint(lastID)
	if lastID != 0 && len(cache.retMapping) == 1 && cache.retMapping[0] == officeMapping["id"] {
		goto CacheNoHooks
	}
...
func OfficeExistsG(ctx context.Context, iD uint) (bool, error) {
	return OfficeExists(ctx, boil.GetContextDB(), iD)
}

// OfficeExistsP checks if the Office row exists. Panics on error.
func OfficeExistsP(ctx context.Context, exec boil.ContextExecutor, iD uint) bool {
...
func OfficeExistsGP(ctx context.Context, iD uint) bool {
...
func OfficeExists(ctx context.Context, exec boil.ContextExecutor, iD uint) (bool, error) {
	var exists bool
